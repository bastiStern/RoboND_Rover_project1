...
class RoverState():
    def __init__(self):
        ...
        self.stop_forward = 150 # Threshold to initiate stopping 50
        self.go_forward = 800 # Threshold to go forward again 500
        self.max_vel = 3 # Maximum velocity (meters/second) 2
